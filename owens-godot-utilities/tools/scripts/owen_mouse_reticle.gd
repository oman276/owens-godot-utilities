...
# OwenMouseReticle
# A simple mouse reticle for 2D games.
# version 1.0.0
# last updated: 2025-10-26

# Usage Notes:
# This is intended to be used with the existing MouseReticle object.
# You can instance this scene and add it to your UI layer to have a
# custom mouse reticle per-scene.

# The GameManager can also manage a global mouse reticle if desired,
...
# The sprite used for the mouse reticle.
@onready var mouse_sprite : Sprite2D = $Sprite2D
# Locally tracking whether the reticle is active.
...
# TODO: Need to actually add the reticle tscn file