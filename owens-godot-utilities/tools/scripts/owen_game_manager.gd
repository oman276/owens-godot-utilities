...
# Loading is set to off by default. Enable if if you have the rest of the loading screen implemented.
...
@export var initial_level : Levels = Levels.NONE
...
# Mouse Reticle
# Define a custom mouse reticle to replace the system cursor.
